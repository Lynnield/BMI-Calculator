    ...
    public void myButtonListenerMethod() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView normSuggestion = findViewById(R.id.normSuggestion);
                normSuggestion.setVisibility(View.GONE);

                TextView norm1Suggestion = findViewById(R.id.norm1Suggestion);
                norm1Suggestion.setVisibility(View.GONE);
